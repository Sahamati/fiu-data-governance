        ...
        "FI": [
            {
                ...
                "KeyMaterial": {
                    "cryptoAlg": crypto_keys['KeyMaterial']['cryptoAlg'],
                    "curve": crypto_keys['KeyMaterial']['curve'],
                    "params": crypto_keys['KeyMaterial']['params'],
                    "DHPublicKey": {
                        "expiry": crypto_keys['KeyMaterial']['DHPublicKey']['expiry'],
                        "Parameters": crypto_keys['KeyMaterial']['DHPublicKey']['Parameters'],
                        "KeyValue": crypto_keys['KeyMaterial']['DHPublicKey']['KeyValue']
                    },
                    "Nonce": nonce
                }
            }
